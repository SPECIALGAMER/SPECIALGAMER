...
TOKEN = '7616886224:AAHWycRe_TQmGPDlv3ZI_dEH4dbqDxSi_VE'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002332401120
CHANNEL_ID = -1002332401120
error_channel_id = -1002332401120
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED MC🤡*", parse_mode='Markdown')
...
def send_welcome(message):
    ...
    btn5 = KeyboardButton("paid file ")
    btn6 = KeyboardButton("Contact owner✔️")
...
def handle_message(message):
    ...
    elif message.text == "paid file ":
        bot.reply_to(message, "*@MANTEL_DC*", parse_mode='Markdown')
    elif message.text == "Contact owner✔️":
        bot.reply_to(message, "*@mantel_dc*", parse_mode='Markdown')
    else:
